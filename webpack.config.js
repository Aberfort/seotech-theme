...
const themePath = '/wp-content/themes/seotech';
...
module.exports = {
	...
	// Для нормальной компиляции Vue
	resolve: {
		alias: {
			vue: ! isDev ? 'vue/dist/vue.min.js' : 'vue/dist/vue.js',
		},
	},
	optimization: {
		minimize: true,
	...
	plugins: [
		...
		new ImageminPlugin({
			test: isDev ? /\.(gif)$/i : /\.(jpe?g|png|gif|svg)$/i,
